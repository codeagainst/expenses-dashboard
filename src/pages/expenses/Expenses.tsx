      ...
      <div className={styles.expensesCard}>
        <section className={styles.expensesOverview}>
          ...
          <div className={styles.expensesOverviewHeader}>
            ...
            <button>
              <img className={styles.expenseOption} src={menuIcon} alt="options" />
            </button>
          </div>
          ...
          <ul>
            {todayExpenses.map((expense) => (
              ...
              <div className={styles.expenseItemLeft}>
                <div style={{backgroundColor: expense.iconBackgroundColor}}
          ...
          <div className={styles.expensesOverviewHeader}>
            <p className={styles.expensesOverviewTitle}>Monday, 23 March 2021</p>
            <button>
              <img className={styles.expenseOption} src={menuIcon} alt="options" />
            </button>
          </div>
        ...
        <section className={styles.moneyOverview}>
          ...
          <div className={styles.saveMoneyDiv}>
            ...
            <p className={styles.saveMoneyInfo}>eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim.
            </p>
